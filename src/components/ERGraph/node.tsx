function Node(Graphin, itemHeight, customOffset) {
  Graphin.registerNode('dice-er-box', {
    draw(cfg, group) {
      const width = 250;
      const height = 96 + customOffset;
      const itemCount = 10;
      const boxStyle = {
        stroke: '#096DD9',
        radius: 4,
      ...
      group.addShape('rect', {
        attrs: {
          x: 0,
          y: collapsed ? 30 : 80 + customOffset,
          height: 15,
          width,
          fill: '#eee',
      ...
      group.addShape('text', {
        attrs: {
          x: width / 2 - 6,
          y: (collapsed ? 30 : 80 + customOffset) + 12,
          text: collapsed ? '+' : '-',
          width,
          fill: '#000',
          radius: [0, 0, boxStyle.radius, boxStyle.radius],
